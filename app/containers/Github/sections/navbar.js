        ...
        <Row backgroundColor="#7161d6" height="4rem">
            ...
            <Row width="null">
                ...
                <Row
                    ...
                    margin="0 0 0 10px"
                    borderRadius="5px">
                    <Link to="/"><Text margin="5px 0 5px 0" color="#fff" fontSize="1.2rem">Calendar</Text></Link>
                </Row>
                ...
                <Row
                    ...
                    margin="0 0 0 10px"
                    borderRadius="5px">
                    <Link to="/github"><Text margin="5px 0 5px 0" color="#fff" fontSize="1.2rem">Github</Text></Link>
                </Row>
